...
namespace Avalon
{
   ...
   public class ValkyrieWebConnectionController
   {
      ...
      private HttpAuthorizer _httpAuthorizer;
      ...
      private string _channelName => $"private-channel-test";
      ...
      public ValkyrieWebConnectionController(string pin, string userName)
      {
         _pin = pin;
         _userName = userName;
         _pusher = CreateNewPusherInstance();
      }
      ...
      private Pusher CreateNewPusherInstance()
      {
      ...
      public async Task SubscribeToChannel()
      {
         ...
         try
         {
            ...
            var channel = await _pusher.SubscribeAsync(_channelName).ConfigureAwait(false);
